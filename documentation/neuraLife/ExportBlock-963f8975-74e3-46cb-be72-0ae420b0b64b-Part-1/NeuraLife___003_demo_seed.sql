...
('SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '2025-10-02', 'Gandhi Jayanti', 'GOVERNMENT'),
('SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '2025-10-02', 'Dussehra', 'REGIONAL'),
...
('t1000000-0000-0000-0000-000000000001', 'K. Suresh Kumar',    '+919876543211', 'suresh.kumar@vikashigh.edu.in',   '1985-04-12', 'Male',   'ACTIVE'),
('t1000000-0000-0000-0000-000000000002', 'P. Venkat Rao',       '+919876543212', 'venkat.rao@vikashigh.edu.in',     '1982-07-22', 'Male',   'ACTIVE'),
('t1000000-0000-0000-0000-000000000003', 'S. Lakshmi Devi',     '+919876543213', 'lakshmi.devi@vikashigh.edu.in',   '1988-11-05', 'Female', 'ACTIVE'),
('t1000000-0000-0000-0000-000000000004', 'M. Rama Krishna',     '+919876543214', 'rama.krishna@vikashigh.edu.in',   '1979-03-18', 'Male',   'ACTIVE'),
('t1000000-0000-0000-0000-000000000005', 'T. Anand Babu',       '+919876543215', 'anand.babu@vikashigh.edu.in',     '1990-09-30', 'Male',   'ACTIVE'),
('t1000000-0000-0000-0000-000000000006', 'R. Priya Kumari',     '+919876543216', 'priya.kumari@vikashigh.edu.in',   '1992-01-14', 'Female', 'ACTIVE');
...
('ta000001-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'EMP-001', 'PGT', 'REGULAR', '2015-06-01', 'ACTIVE'),
('ta000001-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000002', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'EMP-002', 'PGT', 'REGULAR', '2012-06-01', 'ACTIVE'),
('ta000001-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000003', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'EMP-003', 'PGT', 'REGULAR', '2018-06-01', 'ACTIVE'),
('ta000001-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000004', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'EMP-004', 'TGT', 'REGULAR', '2010-06-01', 'ACTIVE'),
('ta000001-0000-0000-0000-000000000005', 't1000000-0000-0000-0000-000000000005', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'EMP-005', 'TGT', 'REGULAR', '2020-06-01', 'ACTIVE'),
('ta000001-0000-0000-0000-000000000006', 't1000000-0000-0000-0000-000000000006', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'EMP-006', 'TGT', 'REGULAR', '2021-06-01', 'ACTIVE');
...
('ta000001-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 9,  'A', 'MATHEMATICS', FALSE),
('ta000001-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 9,  'B', 'MATHEMATICS', FALSE),
('ta000001-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'A', 'MATHEMATICS', TRUE),
('ta000001-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'B', 'MATHEMATICS', FALSE),
-- Venkat Rao: Physical Science
('ta000001-0000-0000-0000-000000000002', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 9,  'A', 'PHYSICAL_SCIENCE', FALSE),
('ta000001-0000-0000-0000-000000000002', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'A', 'PHYSICAL_SCIENCE', FALSE),
('ta000001-0000-0000-0000-000000000002', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'B', 'PHYSICAL_SCIENCE', FALSE),
-- Lakshmi Devi: English + Class Teacher 10-B
('ta000001-0000-0000-0000-000000000003', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 9,  'A', 'ENGLISH', FALSE),
('ta000001-0000-0000-0000-000000000003', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'A', 'ENGLISH', FALSE),
('ta000001-0000-0000-0000-000000000003', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'B', 'ENGLISH', TRUE),
-- Rama Krishna: Telugu
('ta000001-0000-0000-0000-000000000004', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 9,  'A', 'TELUGU', FALSE),
('ta000001-0000-0000-0000-000000000004', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'A', 'TELUGU', FALSE),
('ta000001-0000-0000-0000-000000000004', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'B', 'TELUGU', FALSE),
-- Anand Babu: Social Studies
('ta000001-0000-0000-0000-000000000005', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'A', 'SOCIAL_STUDIES', FALSE),
('ta000001-0000-0000-0000-000000000005', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'B', 'SOCIAL_STUDIES', FALSE),
-- Priya Kumari: Bio Science + Class Teacher 9-A
('ta000001-0000-0000-0000-000000000006', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 9,  'A', 'BIOLOGICAL_SCIENCE', TRUE),
('ta000001-0000-0000-0000-000000000006', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'A', 'BIOLOGICAL_SCIENCE', FALSE),
('ta000001-0000-0000-0000-000000000006', 'SCH-AP-DEMO-0001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10, 'B', 'BIOLOGICAL_SCIENCE', FALSE);
...
('t1000000-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', '2025-06-01', 22000, 'PERCENT', 25, 'PERCENT', 10, 1500, 1600, 32800, TRUE,  FALSE, TRUE, 'XXXX001234', 'HDFC0001234', 'HDFC Bank', 'K. Suresh Kumar',  TRUE),
('t1000000-0000-0000-0000-000000000002', 'SCH-AP-DEMO-0001', '2025-06-01', 24000, 'PERCENT', 25, 'PERCENT', 10, 1500, 1800, 35700, TRUE,  FALSE, TRUE, 'XXXX002345', 'SBIN0002345', 'SBI',       'P. Venkat Rao',    TRUE),
('t1000000-0000-0000-0000-000000000003', 'SCH-AP-DEMO-0001', '2025-06-01', 20000, 'PERCENT', 25, 'PERCENT', 10, 1500, 1500, 30000, FALSE, FALSE, TRUE, 'XXXX003456', 'HDFC0003456', 'HDFC Bank', 'S. Lakshmi Devi',  TRUE),
('t1000000-0000-0000-0000-000000000004', 'SCH-AP-DEMO-0001', '2025-06-01', 18000, 'PERCENT', 20, 'PERCENT', 10, 1200, 1200, 25800, FALSE, TRUE,  TRUE, 'XXXX004567', 'CNRB0004567', 'Canara',    'M. Rama Krishna',  TRUE),
('t1000000-0000-0000-0000-000000000005', 'SCH-AP-DEMO-0001', '2025-06-01', 17000, 'PERCENT', 20, 'PERCENT', 10, 1200, 1000, 24100, FALSE, TRUE,  TRUE, 'XXXX005678', 'PUNB0005678', 'PNB',       'T. Anand Babu',    TRUE),
('t1000000-0000-0000-0000-000000000006', 'SCH-AP-DEMO-0001', '2025-06-01', 18000, 'PERCENT', 20, 'PERCENT', 10, 1200, 1200, 25800, FALSE, TRUE,  TRUE, 'XXXX006789', 'ICIC0006789', 'ICICI',     'R. Priya Kumari',  TRUE);
...
('t1000000-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', '2025-26', 12, 3, 10, 1, 8, 0),
('t1000000-0000-0000-0000-000000000002', 'SCH-AP-DEMO-0001', '2025-26', 12, 1, 10, 0, 8, 0),
('t1000000-0000-0000-0000-000000000003', 'SCH-AP-DEMO-0001', '2025-26', 12, 6, 10, 2, 8, 0),
('t1000000-0000-0000-0000-000000000004', 'SCH-AP-DEMO-0001', '2025-26', 12, 2, 10, 3, 8, 1),
('t1000000-0000-0000-0000-000000000005', 'SCH-AP-DEMO-0001', '2025-26', 12, 0, 10, 0, 8, 0),
('t1000000-0000-0000-0000-000000000006', 'SCH-AP-DEMO-0001', '2025-26', 12, 1, 10, 1, 8, 0);
...
('NID-2025-AP-084291', 'ENROLLMENT_PRINCIPAL', 'PRINCIPAL', 't1000000-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', '1.0', NOW() - INTERVAL '100 days'),
('NID-2025-AP-084303', 'ENROLLMENT_PRINCIPAL', 'PRINCIPAL', 't1000000-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', '1.0', NOW() - INTERVAL '100 days'),
('NID-2025-AP-084313', 'ENROLLMENT_PRINCIPAL', 'PRINCIPAL', 't1000000-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', '1.0', NOW() - INTERVAL '100 days'),
('NID-2025-AP-084320', 'ENROLLMENT_PRINCIPAL', 'PRINCIPAL', 't1000000-0000-0000-0000-000000000001', 'SCH-AP-DEMO-0001', '1.0', NOW() - INTERVAL '100 days');
